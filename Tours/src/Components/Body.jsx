...
function Body() {
    return (
        <>
        <div className="w-1/4 bg-white m-5 p-4">
  <img src="https://www.course-api.com/images/tours/tour-1.jpeg" alt="" />
  ...
  <button className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded m-4">
    not intresed
  </button>
</div>
<div className="w-1/4 bg-white m-5 p-4 ">
  <img src="https://www.course-api.com/images/tours/tour-2.jpeg" alt="" />
  <h3> Best of Ireland in 14 Days Tour</h3>
  <p>
...
<div className="w-1/4 bg-white m-5 p-4 ">
  <img src="https://www.course-api.com/images/tours/tour-3.jpeg" alt="" />
  <h3> Best of Salzburg & Vienna in 8 Days Tour</h3>
  <p>
...
<div className="w-1/4 bg-white m-5 p-4">
  <img src="https://www.course-api.com/images/tours/tour-4.jpeg" alt="" />
  <h3>Best of Rome in 7 Days Tour</h3>
  <p>
...
<div className="w-1/4 bg-white m-5 p-4 ">
  <img src="https://www.course-api.com/images/tours/tour-5.jpeg" alt="" />
  <h3>Best of Poland in 10 Days Tour</h3>
  <p>
